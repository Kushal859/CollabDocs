"""
CollabDocs :- what has been done here 
- ModelSerializers for all 8 models
- 2+ SerializerMethodField (Document.versions_count, Workspace.member_count, Comment.reply_count)
- 2+ custom validators (Tag.name uniqueness/format, Document.title length, Comment.parent doc match)
- Transactional create/update on Document (versions + audit handled together)
"""
